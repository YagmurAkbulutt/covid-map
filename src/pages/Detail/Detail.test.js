...
//test ortamındaki storeun kurulumunu yap, projede thunk kullandığımız için tanıtıyoruz
const mockStore = configureStore({thunk})


it("yüklenme durumunda loader bileşenleri ekrana basılır", () => {
   
    //loading durumunda storedaki veriyi simüle ediyoruz
   const store = mockStore({covidReducer:{
    ...
    //loaderlar ekrana geliyor mu kontrol et
...
it("veri gelme durumunda ülke bilgisi ve kartlar ekrana basılır", () => {
    ...
    // resim kaynağı datadaki url ile aynı mı
